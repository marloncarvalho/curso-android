 ...
 * 		2.4. Clicar em Create New Server Key - É melhor para colocar uma whitelist de IPs de
 ...
 * 
 * 4.4. Adicionar o seu próprio Serviço <service
 * android:name=".GCMIntentService" />
 * 
 * 5. Criar o Serviço que estende de GCMBaseIntentService 5.1. Sobrescrever os
 * métodos
 * 
